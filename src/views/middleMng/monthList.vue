<template>
  ...
  <el-form :inline="true" :model="form" ref="formRef">
    ...
    <el-form-item label="时间范围">
      <el-date-picker v-model="dateRange" type="monthrange" value-format="YYYYMM" :disabled-date="$pickerOptions.disabledDate" />
    </el-form-item>
    <el-form-item>
      <el-button type="primary" @click="getList">搜索</el-button>
      <el-button @click="handleReset">重置</el-button>
      <el-button type="primary" v-hasPermi="['monthList:export']">导出</el-button>
    </el-form-item>
  </el-form>
  <!-- 表格 -->
